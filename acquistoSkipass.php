...
<?php
    ...
    if(!isset($_SESSION['pass'])) {
        ...
        echo "<div>
        <h1>Acquista uno Skipass</h1></div>
        <div class='card'>
            <h1>I tuoi dati:</h1>";
        ...
        if($riga != 0) {
            ...
            echo "</div><div><h2>Altrimenti visualizza le tue prossime risalite già prenotate <a href='visualizza.php'>qui</a></h2></div>";
            exit();
        } else {
...
?>
        ...
        <div class="piani">
            <form action="creazioneSkipass.php" method="POST">
                ...
                <input type="radio" id="piano1" name="piano1" value="5">
                <h2>Piano 2</h2>
                <p>Numero di risalite: 10</p>
                <input type="radio" id="piano2" name="piano2" value="10">
                <h2>Piano 3</h2>
                <p>Numero di risalite: 15</p>
                <input type="radio" id="piano3" name="piano3" value="15"><br/>
